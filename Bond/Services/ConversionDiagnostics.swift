...
/// On-device record of how someone met Bond+ before they bought it: which
...
enum ConversionDiagnostics {
    private static let logger = Logger(subsystem: "com.jackwallner.bond", category: "Conversion")
    ...
    private static let impressionPrefix = "bond_"
